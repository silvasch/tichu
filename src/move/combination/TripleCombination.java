...
public class TripleCombination extends Move implements Comparable<TripleCombination> {
  ...
  public boolean equals(TripleCombination other) {
    if ((cardOne.equals(other.cardOne)
            || cardOne.equals(other.cardTwo)
            || cardOne.equals(other.cardThree))
        && (cardTwo.equals(other.cardOne)
            || cardTwo.equals(other.cardTwo)
            || cardTwo.equals(other.cardThree))
        && (cardThree.equals(other.cardOne)
            || cardThree.equals(other.cardTwo)
            || cardThree.equals(other.cardThree))) {
      return true;
    }
    return false;
  }
