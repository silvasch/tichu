        ...
        .equals(
            new StairCombination(
                new PairCombination[] {
                  ...
                  new PairCombination(
                      new NormalCard(Suit.GREEN, Rank.KING), new NormalCard(Suit.BLUE, Rank.KING))
                }));
            ...
            new StairCombination(
                new PairCombination[] {
                  ...
                  new PairCombination(
                      new NormalCard(Suit.GREEN, Rank.KING), new NormalCard(Suit.BLUE, Rank.KING)),
                  new PairCombination(
                      new NormalCard(Suit.GREEN, Rank.QUEEN), new NormalCard(Suit.BLUE, Rank.QUEEN))
                }));
        ...
        .equals(
            new FullHouseCombination(
                new TripleCombination(
                    ...
                    new NormalCard(Suit.BLUE, Rank.TWO)),
                new PairCombination(
                    new NormalCard(Suit.BLACK, Rank.THREE), new NormalCard(Suit.RED, Rank.THREE))));

    assert Move.constructFromCards(
            new Card[] {new NormalCard(Suit.BLACK, Rank.ACE), new NormalCard(Suit.RED, Rank.ACE)})
        .equals(
            new PairCombination(
                new NormalCard(Suit.BLACK, Rank.ACE), new NormalCard(Suit.RED, Rank.ACE)));
