...
public class SerializationTester {
    public static void main(String[] args) throws Exception {
        ...
        TripleCombination triple = new TripleCombination(new NormalCard(Suit.BLACK, Rank.ACE),
                new NormalCard(Suit.BLUE, Rank.ACE), new NormalCard(Suit.GREEN, Rank.ACE));
        ...
        StreetCombination street = new StreetCombination(new NormalCard[] {
        ...
        StairCombination stair = new StairCombination(new PairCombination[] {
                new PairCombination(new NormalCard(Suit.BLACK, Rank.SEVEN), new NormalCard(Suit.BLUE, Rank.SEVEN)),
                new PairCombination(new NormalCard(Suit.RED, Rank.EIGHT), new NormalCard(Suit.BLACK, Rank.EIGHT)),
        });
