...
public class DeserializationTester {
  ...
  private static void normalCardDeserializationTest() throws Exception {
    ...
    PartialDeserialization<NormalCard> de =
        NormalCard.partialDeserialize(normalCard.serialize() + ",asdf");
  ...
  private static void singleCombinationDeserializationTest() throws Exception {
    ...
    PartialDeserialization<SingleCombination> de =
        SingleCombination.partialDeserialize(single.serialize() + ",asdf");
  ...
  private static void pairCombinationDeserializationTest() throws Exception {
    PairCombination pair =
        new PairCombination(
            new NormalCard(Suit.BLACK, Rank.ACE), new NormalCard(Suit.GREEN, Rank.ACE));
    PartialDeserialization<PairCombination> de =
        PairCombination.partialDeserialize(pair.serialize() + ",asdf");
  ...
  private static void tripleCombinationDeserializationTest() throws Exception {
    ...
    PartialDeserialization<TripleCombination> de =
        TripleCombination.partialDeserialize(triple.serialize() + ",asdf");
  ...
  private static void fullHouseCombinationDeserializationTest() throws Exception {
    ...
    PartialDeserialization<FullHouseCombination> de =
        FullHouseCombination.partialDeserialize(fullHouse.serialize() + ",asdf");
  ...
  private static void streetCombinationDeserializationTest() throws Exception {
    ...
    PartialDeserialization<StreetCombination> de =
        StreetCombination.partialDeserialize(street.serialize() + ",asdf");
  ...
  private static void stairCombinationDeserializationTest() throws Exception {
    StairCombination stair =
        new StairCombination(
            new PairCombination[] {
              new PairCombination(
                  new NormalCard(Suit.BLACK, Rank.FIVE), new NormalCard(Suit.RED, Rank.FIVE)),
              new PairCombination(
                  new NormalCard(Suit.BLACK, Rank.SIX), new NormalCard(Suit.RED, Rank.SIX)),
            });
    PartialDeserialization<StairCombination> de =
        StairCombination.partialDeserialize(stair.serialize() + ",asdf");
